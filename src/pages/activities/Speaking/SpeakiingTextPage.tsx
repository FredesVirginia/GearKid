...
const SpeakingTextPage: React.FC<AudioRecorderProps> = ({ onRecord }) => {
    ...
    return (
        ...
        >
            <div>
                ...
                <h1 style={{ color: getColor("my-purple-900") }} className="text-center text-3xl font-bold">  {INITIAL_DATA.text}</h1>
                <h2 style={{ color: getColor("my-purple-500") }} className="text-center text-2xl"> {INITIAL_DATA.textTraslation}</h2>
