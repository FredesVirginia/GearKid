...
const SpeakingImagePage: React.FC<AudioRecorderProps> = ({ onRecord }) => {
        ...
        >
             <div className="flex justify-center items-center space-x-2"> 
                <div className="border border-gray-400 p-5 rounded-md">
                    <img src="../../../img/apple.png" className="w-[200px] h-[200px] " />
                </div>
                <div>

                <h1 style={{ color: getColor("my-purple-900") }} className="text-center text-2xl font-bold"> {INITIAL_DATA.text}</h1>
                <h2 style={{ color: getColor("my-purple-500") }} className="text-center text-xl"> {INITIAL_DATA.textTraslation}</h2>
...
export default SpeakingImagePage;