...
const INITIAL_DATA = {
  questionId: "243",
  columnName: ["Clothes", "Fruit", "Tecnology", "Dessent"],
  imgs: [
    { id: 0, url: "https://www.starkbros.com/images/dynamic/4778-360x270-fillv.jpg" },
    {
      id: 1,
      url: "https://www.familyhandyman.com/wp-content/uploads/2017/07/shutterstock_258205901.jpg?fit=696%2C696",
    },
    {
      id: 0,
      url: "https://i0.wp.com/www.texcolsport.com/wp-content/uploads/2021/05/1619816199703.jpg?fit=1200%2C1200&ssl=1",
    },
    { id: 2, url: "https://www.aalanco.com/wp-content/uploads/2014/01/phone-contact.jpg" },

    { id: 0, url: "https://blog.vitalityextracts.com/wp-content/uploads/2019/04/o2.jpg" },
    {
      id: 2,
      url: "https://www.bhphotovideo.com/images/images2500x2500/asus_ux431fa_eh55_zenbook_i5_10210u_8gb_512gb_1549032.jpg",
    },
    { id: 1, url: "https://th.bing.com/th/id/OIP.Y8eLCeOg5nuYMW8q5aSjEQHaHa?rs=1&pid=ImgDetMain" },
    { id: 1, url: "https://acuatrolados.com/wp-content/uploads/2016/09/bizcocho-postentrenamiento.jpg" },
  ],
};
...
const SortableImgPage = () => {
  ...
  const GridItem: React.FC<{
    ...
    return (
      <div
        ...
        className="bg-  rounded-2xl w-[100px] h-[100px] relative"
        style={{ opacity: isDragging ? 0.5 : 1, boxShadow: "0px 6px 4px 0px rgba(0, 128, 0, 1)" }}
      >
        <img
  ...
  const [grid, setGrid] = React.useState<GridItem[]>(requestGET.imgs);
              ...
              <DndProvider backend={HTML5Backend}>
                <div className="flex space-x-5 justify-evenly  w-full my-3  ">
                  {array.map((item, index) => (
                    <div
                      key={index}
                      className="text-sm  rounded-xl px-10 py-1 border  "
                      style={{
                        borderColor: getColor("my-green-sortable"),
                        color: getColor("my-green-sortable-strong"),
                      }}
                    >
                      {item}
                    </div>
...
export default SortableImgPage;
