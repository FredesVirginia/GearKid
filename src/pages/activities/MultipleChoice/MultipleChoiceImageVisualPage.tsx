           ...
           <div className="flex justify-center space-x-4  ">
                <div className="flex space-x-24">
                    ...
                    <div className="flex flex-col space-y-12">
                        <h2 className="text-left p-3 text-xl font-extrabold w-[900px] pr-60 py-4 rounded-xl" style={{backgroundColor : getColor("my-blue-200") , color : getColor("my-blue-900")}}> {INITIAL_DATA.intruncion}</h2>
